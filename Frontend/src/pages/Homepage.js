    ...
    await client
      ...
      .then((response) => {
        ...
        Toast.fire({
          ...
          let path = [...paths[algorithmId % 2], drvingTestUrl[algorithm]];
          console.log(path);
          localStorage.setItem("path", JSON.stringify(path));
          window.location.pathname = window.location.pathname.slice(1, 21) + JSON.parse(localStorage.getItem("path"))[0];
        });
      })
      .catch((error) => {
